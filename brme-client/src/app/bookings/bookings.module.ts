...
import { SpecialBookerComponent } from './components/special-booker/special-booker.component';
...
@NgModule({
  ...
  declarations: [HomeComponent, RoomComponent, DayComponent, DatePickerComponent, SlotComponent, SpecialBookerComponent]
})
